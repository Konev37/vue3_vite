...
export function targetExecution() {
  return request({
    url: '/scenario/robot/execution_1',
    method: 'get'
  })
}
...
export function getGeoEntityTables() {
  return request({
    url: '/scenario/robot/geoTables_1',
    method: 'get'
  })
}
...
export function getTaskCompRate() {
    return request({
        url: '/scenario/robot/taskCompRate_1',
        method: 'get'
    })
}
...
export function getAgentsLossRate() {
    return request({
        url: '/scenario/robot/agentsLossRate_1',
        method: 'get'
    })
}
...
export function editAgentsLossRate(data) {
    return request({
        url: '/scenario/robot/setAgentsLossRate_1',
        method: 'put',
        data: data,
    })
}
...
export function targetExecution() {
  return request({
    url: '/scenario/robot_1/execution',
    method: 'get'
  })
}
...
export function getGeoEntityTables() {
  return request({
    url: '/scenario/robot_1/geoTables',
    method: 'get'
  })
}
...
export function getTaskCompRate() {
    return request({
        url: '/scenario/robot_1/taskCompRate',
        method: 'get'
    })
}
...
export function getAgentsLossRate() {
    return request({
        url: '/scenario/robot_1/agentsLossRate',
        method: 'get'
    })
}
...
export function editAgentsLossRate(data) {
    return request({
        url: '/scenario/robot_1/setAgentsLossRate',
        method: 'put',
        data: data,
    })
}
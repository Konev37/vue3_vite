...
export function targetExecution() {
  return request({
    url: '/scenario/robot/execution_3',
    method: 'get'
  })
}
...
export function getGeoEntityTables() {
  return request({
    url: '/scenario/robot/geoTables_3',
    method: 'get'
  })
}
...
export function getTaskCompRate() {
    return request({
        url: '/scenario/robot/taskCompRate_3',
        method: 'get'
    })
}
...
export function getAgentsLossRate() {
    return request({
        url: '/scenario/robot/agentsLossRate_3',
        method: 'get'
    })
}
...
export function editAgentsLossRate(data) {
    return request({
        url: '/scenario/robot/setAgentsLossRate_3',
        method: 'put',
        data: data,
    })
}
...
export function targetAssignment() {
  return request({
    url: '/scenario/robotuav/assign_2',
    method: 'get'
  })
}
...
export function targetExecution() {
  return request({
    url: '/scenario/robotuav/execution_2',
    method: 'get'
  })
}
...
export function getEntityTables() {
  return request({
    url: '/scenario/robotuav/tables_2',
    method: 'get'
  })
}
...
export function getGeoEntityTables() {
  return request({
    url: '/scenario/robotuav/geoTables_2',
    method: 'get'
  })
}
...
export function getMaxTime() {
  return request({
    url: '/scenario/robotuav/maxTime_2',
    method: 'get'
  })
}
...
export function getTaskCompRate() {
  return request({
      url: '/scenario/robotuav/taskCompRate_2',
      method: 'get'
  })
}
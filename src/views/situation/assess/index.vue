<template>
  <div class="app-container">
    <el-tabs type="border-card" v-model="activeName" class="demo-tabs" @tab-click="handleClick">
      ...
      <el-tab-pane label="红方" name="red" :key="'red'">
        <child1 v-if="isChildUpdate1"></child1>


      </el-tab-pane>
      
        <el-tab-pane label="蓝方" name="blue" :key="'blue'">
          <child2 v-if="isChildUpdate2"></child2>
          <router-link to="/situation/assess/blue"></router-link>

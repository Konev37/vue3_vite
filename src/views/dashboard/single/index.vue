...
for (var j = 0; j < nodes.length; j++) {
  ...
  var ability = parseInt(nodes[j].ability);
  var load = parseInt(nodes[j].load);
  var task = parseInt(nodes[j].task);
  // var tasks = nodes[j].task.split(',');
  // var task = [];
  // for (var k = 0; k < tasks.length; k++) {
  //           task[k] = Integer.parseInt(tasks[k]);
  //       }
  // var value = [];
  // value[0] = x;
  // value[1] = y;
  ...
  tooltip: {
    ...
    formatter: function (params, ticket, callback) {
        ...
        if(params.seriesIndex == 0)//agent的seriesIndex为0，任务迁移的为1
        {
          ...
          tip += "Agent能力：执行任务能力为" + params.value[2] + "<br/>";
          tip += "Agent当前负载：" + params.value[3] + "<br/>";
          tip += "Agent任务：任务" + params.value[4] + "<br/>";
          // for(var k = 2 ; k< params.value.length ; k++){
          //   tip += "Agent任务：任务" + params.value[k] + "<br/>";
          // }
...
//   //   sleep(3000);
//   // }
//   allInfoIntance.setOption(options[1]);
...
//   allInfoIntance.setOption(function (param) {
//     var nodes = [
//   {
//     x: "1",
//     y: "12",
